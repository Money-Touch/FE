...
const ItemQna = ({ qnaId, question, answerList, selectedIndex, onSelectAnswer }: ItemQnaProps) => {
    return (
        <T.ItemOnboardingContainer style={{ gap: "0.7rem"}}>
            <T.OnboardingP style={{ color: colors.G1, fontSize: "1.8rem"}}>Q{qnaId}. {question}</T.OnboardingP>
            <ListAnswer
                answers={answerList}
