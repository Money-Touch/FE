...
const SettingInput = ({
    ...
    return (
        ...
        <S.Wrapper>
            <S.Input type={inputType} {...register} placeholder={placeholder} hasError={!!error} hasButton={hasButton} />

            <SettingInputIcon hasButton={hasButton} hasDelete={showDelete} showPassword={showPassword} onDelete={handleDelete} onToggle={togglePassword} showDelete={showDelete} showToggle={showToggle} />
