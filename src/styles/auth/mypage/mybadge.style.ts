...
export const selectFooter =
  'fixed bottom-0 max-w-[425px] w-full h-[10rem] bg-white rounded-t-[20px] flex justify-between px-[2.4rem] pt-[1.5rem] shadow-[0_0_2px_0_rgba(0,0,0,0.16)] gap-[2.3rem] z-50';
